...
$query1=mysqli_query($DBcon,"SELECT * from post_job");
...
$Type_of_Job= $row['Type_of_Job'];
    ...
    echo "<div class=\"panel-heading\" style=\"font-size:20px\"><p><strong>$output</strong></p></div>";
    echo "<div class=\"panel-body\">"; 
    echo "<p><strong>$output3</strong></p>";
    echo "<p><strong>$output8</strong></p>";
    echo "<p><strong>$output9</strong></p>";
    echo "<p><strong>$output10</strong></p>";
    echo "<button class=\"btn btn-lg\" onclick=\"location.href='view.php'\">View Details </button >";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
